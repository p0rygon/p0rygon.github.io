...
- **scope · 일일 분량** — 3개 지역, 3개 역할을 매일 같은 시각에 수집합니다. 하루 약 450장의 PNG 이미지와 약 4,500명 유저의 데이터가 수집됩니다.
...
- LEADERBOARD · AUTOMATION: 27개월 운영 / 450+ PNG/일 자동 수집 / 4,500 플레이어/일 분석 · 2023.10 - 2026.01
